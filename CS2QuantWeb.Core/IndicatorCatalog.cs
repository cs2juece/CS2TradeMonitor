...
public static class IndicatorCatalog
{
    ...
    [
        ...
        One("BOLL", "BOLL（布林线）", MainAndSub, [P("period", "周期", 20, 2, 500), P("deviation", "标准差", 2, 0.1, 20, 2)], [("upper", "UP"), ("mid", "MID"), ("lower", "DN")]),
        ...
        One("BOLL", "BOLL（布林线）", SubOnly, [P("period", "周期", 20, 2, 500), P("deviation", "标准差", 2, 0.1, 20, 2)], [("upper", "UP"), ("mid", "MID"), ("lower", "DN")], duplicateCode: true),
