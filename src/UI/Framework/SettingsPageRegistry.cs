...
namespace CS2TradeMonitor.src.UI.Framework
{
    ...
    public static class SettingsPageRegistry
    {
        private static readonly SettingsPageRoute[] Routes =
        {
            ...
            new("QuantResearch", () => "📊 量化研究", typeof(QuantResearchEntryHostPage), () => new QuantResearchEntryHostPage()),
        ...
        private static readonly Dictionary<string, string> Aliases = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["YouPinInventoryStorage"] = "YouPin:InventoryStorage",
            ["YouPinSaleReminder"] = "YouPin:Quote",
            ["YouPinQuote"] = "YouPin:Quote",
            ["YouPinAutoQuote"] = "YouPin:AutoQuote",
            ["YouPinGrid"] = "YouPin:Grid",
            ["YouPinTradingGrid"] = "YouPin:Grid",
            ["YouPinCc"] = "YouPin:Cc",
